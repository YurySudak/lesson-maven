...
public class CalcUtilTest {
    ...
    public static final Teacher teacher1 = new Teacher("name", List.of(400.0, 600.0));
    public static final Teacher teacher2 = new Teacher("name", List.of(400.0));
    public static final Teacher teacher3 = new Teacher("name", List.of(0.0));
    public static final Teacher teacher4 = new Teacher("name", List.of(400.0, 400.0, 600.00, 600.00));
